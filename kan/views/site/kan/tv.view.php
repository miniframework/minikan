...
<div id="searching" class="fm960 clearfix">
  <div class="searching-bd">
    <ul class="kinds clearfix">
      <li><a class="on"
					href="<?php echo $this->createUrl("site","kan","tv",array("page"=>1),array("area"=>$search['area'],"year"=>$search['year'],"star"=>$search['star'],"order"=>$search['order']));?>">全部类型</a></li>
      <?php $cateMap = $vgroup->cateMap(2);
			foreach($cateMap as $k => $cate){ ?>
      <li><a target="_self" <?php if($k==$search['cate']) echo 'class="on"';?>
					href="<?php echo $this->createUrl("site","kan","tv",array("page"=>1),array("cate"=>$k,"area"=>$search['area'],"year"=>$search['year'],"star"=>$search['star'],"order"=>$search['order']));?>"><?php echo $cate;?></a></li>
      <?php }?>
    </ul>
    <ul class="region clearfix">
      <li><a class="on" 
					href="<?php echo $this->createUrl("site","kan","tv",array("page"=>1),array("cate"=>$search['cate'],"year"=>$search['year'],"star"=>$search['star'],"order"=>$search['order']));?>">全部地区</a></li>
      <?php $areaMap = $vgroup->areaMap(2);
			foreach($areaMap as $k => $area){ ?>
      <li><a target="_self" <?php if($k==$search['area']) echo 'class="on"';?>
					href="<?php echo $this->createUrl("site","kan","tv",array("page"=>1),array("cate"=>$search['cate'],"area"=>$k,"year"=>$search['year'],"star"=>$search['star'],"order"=>$search['order']));?>"><?php echo $area;?></a></li>
      <?php }?>
    </ul>
    <ul class="years clearfix">
      <li><a class="on" 
					href="<?php echo $this->createUrl("site","kan","tv",array("page"=>1),array("cate"=>$search['cate'],"area"=>$search['area'],"star"=>$search['star'],"order"=>$search['order']));?>">全部年代</a></li>
      <?php $yearMap = $vgroup->yearMap();
			foreach($yearMap as $k => $year){ ?>
      <li><a target="_self" <?php if($k==$search['year']) echo 'class="on"';?>
					href="<?php echo $this->createUrl("site","kan","tv",array("page"=>1),array("cate"=>$search['cate'],"area"=>$search['area'],"year"=>$k,"star"=>$search['star'],"order"=>$search['order']));?>"><?php echo $year;?></a></li>
      <?php }?>
    </ul>
   <ul class="perform clearfix">
				<li><a class="on" href="<?php echo $this->createUrl("site","kan","tv",array("page"=>1),array("cate"=>$search['cate'],"area"=>$search['area'],"year"=>$search['year'],"order"=>$search['order']));?>">全部明星</a></li>
				
				<?php $starMap = $vgroup->starMap(2);
				foreach($starMap as $k => $star){ ?>
				<li><a target="_self" <?php if($star==$search['star']) echo 'class="on"';?>
					href="<?php echo $this->createUrl("site","kan","tv",array("page"=>1),array("star"=>$star,"order"=>$search['order']));?>"><?php echo $star;?></a></li>
				<?php }?>
				<?php if(!in_array($search['star'], $starMap) && !empty($search['star'])) {?>
				<li><a target="_self" class="on" href="<?php echo $this->createUrl("site","kan","tv",array("page"=>1),array("star"=>$search['star']));?>"><?php echo $search['star'];?></a></li>
  ...
  <div class="searching-ft clearfix">
    <div class="tab">
      		<?php $orderMap = $vgroup->getOrder();
			      ...
			      href="<?php echo $this->createUrl("site","kan","tv",array("page"=>1),array("cate"=>$search['cate'],"area"=>$search['area'],"year"=>$search['year'],"star"=>$search['star'],"order"=>$k));?>">
			      <?php echo $order;?></a> 
			      <?php if($end != $k) {?>
						<em>&nbsp;|</em>
				  <?php } ?>
		    ...
		    <ul class="title_order_box">                             
			    ...
			    <li><span><?php echo $cateMap[$search['cate']];?><a href="<?php echo $this->createUrl("site","kan","tv",array("page"=>1),array("area"=>$search['area'],"year"=>$search['year'],"order"=>$search['order']));?>" class="ct"></a></span></li>
			    <?php }?>
			    <?php if(!empty($search['area']) && array_key_exists($search['area'], $areaMap)) {?>
			    <li><span><?php echo $areaMap[$search['area']];?><a href="<?php echo $this->createUrl("site","kan","tv",array("page"=>1),array("cate"=>$search['cate'],"year"=>$search['year'],"order"=>$search['order']));?>" class="ct"></a></span></li> 
			    <?php }?>
			    <?php if(!empty($search['year']) && array_key_exists($search['year'], $yearMap)) {?>
			    <li><span><?php echo $yearMap[$search['year']];?><a href="<?php echo $this->createUrl("site","kan","tv",array("page"=>1),array("cate"=>$search['cate'],"area"=>$search['area'],"order"=>$search['order']));?>" class="ct"></a></span></li>
			    <?php }?>
		    </ul>
		    <?php }?>
  </div>
  ...
  <ul class="clearfix">
    ...
    <li>
      <dl>
        ...
        <dd class="intro"> 简介：<span><?php echo $model->getCutSummary(38);?></span> <a href="<?php  echo $this->createUrl('site','kan','player',array('id'=>$model->id));?>">[详情]</a> </dd>
        <dd class="player">
